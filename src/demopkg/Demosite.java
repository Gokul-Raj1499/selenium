...
public class Demosite {
	...
	public Demosite(WebDriver driver2) {
		this.driver = driver2;
	}

	public void inputvalues(String firstname1, String lastname1, String address1, String email1, String phoneno1,
		...
		String filePATH = "C:\\Users\\Dell\\Pictures\\Screenshots\\Screenshot (1).png";
		fileupload(filePATH);
		gender();
		hobbiesselected();
